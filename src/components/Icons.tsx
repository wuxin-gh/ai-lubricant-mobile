...
export const Icons: Record<string, IconFn> = {
  ...
  // 滑杆（tune）：配置/管理入口的标准意象。
  sliders: (p) => <Ic {...p}><Path d="M4 7h10M18 7h2M4 17h4M12 17h8" /><Circle cx={15.5} cy={7} r={2.6} /><Circle cx={9.5} cy={17} r={2.6} /></Ic>,
  // 铃铛：通知。
  bell: (p) => <Ic {...p}><Path d="M18 8a6 6 0 1 0-12 0c0 7-3 9-3 9h18s-3-2-3-9" /><Path d="M13.7 21a2 2 0 0 1-3.4 0" /></Ic>,
  // 标准齿轮（feather settings）：系统/常规设置用；旧 settings 画出来像太阳，逐步替换。
  gear: (p) => <Ic {...p}><Circle cx={12} cy={12} r={3} /><Path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09a1.65 1.65 0 0 0 1.51-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33h0a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51h0a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82v0a1.65 1.65 0 0 0 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" /></Ic>,
  ...
  radar: (p) => <Ic {...p}><Path d="M12 12l6.4-3.7" /><Path d="M12 12l-1 7.6" /><Path d="M12 12L4.4 8.9" /><Circle cx={12} cy={12} r={1.6} fill={p.color} stroke="none" /><Path d="M12 4.5a7.5 7.5 0 0 1 7.5 7.5" strokeOpacity={0.55} /><Path d="M12 1.8a10.2 10.2 0 0 1 8.2 4.2" strokeOpacity={0.3} /></Ic>,
